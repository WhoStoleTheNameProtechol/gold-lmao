...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite(-25, 0);
		bg.frames = Paths.getSparrowAtlas('bgGold');
		bg.animation.addByPrefix('switch', "bg menu", 24);
		bg.animation.play('switch');
		bg.antialiasing = true;
		add(bg);

		logoBl = new FlxSprite(345, 100);
		logoBl.frames = Paths.getSparrowAtlas('loGold');
